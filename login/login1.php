<?php
session_start();
$con = mysqli_connect("localhost:3305", "mirajinn_login", "mirajinn_login", "mirajinn_login");
...
curl_setopt_array($curl, array(
    CURLOPT_URL => 'https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyBpJjHgrTdVNmagIl6f3u1egRHHQWBwC5w&idToken=' . $token,
